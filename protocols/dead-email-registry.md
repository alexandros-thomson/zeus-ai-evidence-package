...
## Section 1: Dead → Correct Replacement

| Dead — Never Use | Correct Replacement | Authority | Notes |
|-----------------|--------------------|-----------|----- |
...
## Section 2: Additional Confirmed Dead Addresses
...
- Active cases on file (via online form): PP.00179 / PP.00267 / PP.00281 / PP.00310 / PP.00464 / PP.00736/2026/EN

### SSA OIG (Social Security Administration Office of Inspector General)
- Email: oig.hotline@ssa.gov ✅ (confirmed working — Prot#478 sent 08/04/2026)
- Online form (REQUIRED for case creation): https://secure.ssa.gov/oig/fraud/
- Phone: 1-800-269-0271

---

## Section 4: ΑΠΔΠΧ (Αρχή Προστασίας Δεδομένων Προσωπικού Χαρακτήρα)
### Greek Data Protection Authority

| Purpose | Address | Status |
|---------|---------|--------|
| Formal complaints | complaints@dpa.gr | ✅ VALID |
| General contact | contact@dpa.gr | ✅ VALID |

- Physical: Λ. Κηφισίας 1-3, ΤΚ 11523, Αθήνα
- Tel: +30 210 6475600
- Portal: https://www.dpa.gr
- GDPR Art. 77 complaints: use complaints@dpa.gr
- Prior ΑΠΔΠΧ filings on record: Prot. #425–426 (03/04/2026, complaints@dpa.gr)

---

## Quick Reference — Correct Addresses (use these)

| Authority | Use This Address |
|-----------|----------------|
...
| ΑΠΔΠΧ complaints | complaints@dpa.gr |

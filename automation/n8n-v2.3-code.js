// Check Status + Parse — v2.3-EISAGGELIKI-protocols
// Last updated: 2026-03-03
// Added: EISAGGELIKI-PARAGGELIA-258b, ATTICA-FORWARD-258b, Protocol 259-261
...
const cases = [
  ...
  // ── Case 7: EISAGGELIKI-PARAGGELIA-258b (NEW) ──
  {
    ...
    risk: 'CRITICAL',
    note: `Eisaggeliki Paraggelia for disclosure of deed 6020/2015 by Notary Lyrakis. 16 attachments. Protocol mismatch 166 vs 136. Lyrakis admitted GDPR shield — only complies with prosecutor order. Day ${daysSinceDeath} since death. Cross-ref EPPO PP.00179/PP.00267/PP.00281/PP.00310.`
  },

  // ── Case 8: ATTICA-FORWARD-258b (NEW) ──
  {
    ...
    risk: 'HIGH',
    note: 'Forward of Lyrakis denial (Prot. 207/26-02-2026) + protocol mismatch evidence to Attica Admin for notarial oversight. Links to existing Prot. 11494/11676.'
  },

  // ── Case 9: SYNIGOROS-258-MISMATCH (Protocol 260 - planned) ──
  {
    ...
    risk: 'HIGH',
    note: 'Synigoros complaint re: administrative obstruction (Lyrakis denial), protocol number manipulation (166 vs 136), GDPR as evidence suppression. Cross-ref EPPO PP.00179.'
  }

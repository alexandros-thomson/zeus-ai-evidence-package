// ================================================================
// Check Status + Parse — v2.9-DEDUP-L1L3
...
// Total tracked cases: 17 | Total protocols: 284+
// ================================================================
//
// CHANGES FROM v2.8-merged:
//   - DEDUP guard wraps output loop
//   - New fields: should_send, dedup_blocked, dedup_layer, dedup_case_id
//   - Summary item appended at end
//   - IF Node must change: $json.overdue → $json.should_send === true
//
// DOWNSTREAM CHANGES REQUIRED:
//   1. IF Node: condition = {{ $json.should_send === true }}
//   2. (Optional) Add Google Sheets Append node after Gmail Send
//      Sheet: "ESCALATION_SEND_LOG"
//      Headers: timestamp | case_id | protocol_number | sent_to | cc | subject | layer_status
// ================================================================
...
// ================================================================
// CASES ARRAY — 16 cases (v2.8-merged + Cases 12-16)
// ================================================================
const cases = [
...
output.push({
  json: {
    ...
    engine_version: 'v2.9-DEDUP-L1L3',

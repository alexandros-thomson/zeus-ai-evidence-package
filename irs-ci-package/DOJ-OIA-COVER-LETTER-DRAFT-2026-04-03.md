...
1301 New York Avenue, Suite 300
Washington, DC 20530

**Attention:** Director Vaughn A. Ary / Deputy Director Mary Rodriguez
**Phone:** 202-616-9682
**MLAT Submissions:** OIA.MLA@usdoj.gov

---

## FROM

SA Clint Zacheranik + SA Henry Pletscher
IRS Criminal Investigation — Detroit Field Office

On behalf of complainant Stamatina Kyprianos (AFM 044594747)
Represented by Kostadinos J. Kyprianos, Kypria LLC
...
1. **U.S.-Greece Mutual Legal Assistance Treaty** — In force 20/11/2001, Article 9 (compulsion of records)
2. **U.S.-Greece Tax Convention (1953)** — Exchange of information provisions
3. **18 USC section 3512** — Authority for federal courts to issue orders in aid of foreign investigations
4. **Hague Service Convention** — For service of process on Greek entities if required
...
- **Notarial Chamber:** Notary Lyrakis invoked GDPR as shield against disclosure while issuing SLAPP threats
...
The MLAT request targets 12 custodians across 12 record categories (see Tab 6 — MLAT/Record-Compulsion Map for full detail):

| Priority | Custodian | Record Type | U.S. Statute |
|----------|-----------|-------------|--------------|
| IMMEDIATE | NBG (National Bank of Greece) | 438 post-death transactions, IP/device logs, IBAN GR030110... | 18 USC 1343 (wire fraud) |
| IMMEDIATE | EFKA/IDYKA | Pension audit logs, AFM 051422558 | 18 USC 1028A |
| IMMEDIATE | AADE TAXISnet | Access/modification logs, both AFMs | 18 USC 1028A |
| HIGH | AADE Comregistry | 1992 business registration originating act | Art. 216 PK (forgery) |
| HIGH | Notarial Chamber | Contract 6020/2020 complete file | 18 USC 1341 |
| HIGH | Cadastre | KAEK property modification history | 18 USC 1341 |
| STANDARD | DEH (Public Power) | 5 active supply contracts in deceased name | MLAT Art. 9 |
| STANDARD | H&R Block | Filed returns TY 2021-2024, preparer files | 26 USC 7206 |

---

## V. CRIMINAL STATUTES IMPLICATED

- **18 USC section 1028A** — Aggravated Identity Theft
- **18 USC section 1341** — Mail Fraud
- **18 USC section 1343** — Wire Fraud (438 counts, EUR 21,616)
- **18 USC section 1519** — Evidence Destruction/Concealment
- **26 USC section 7206(1)/(2)** — Fraudulent Tax Returns / Aiding & Abetting
...
3. OIA to process under U.S.-Greece MLAT Article 9
4. OIA to coordinate with Greek Ministry of Justice (Central Authority) for compelled production
5. Priority routing for Rows 2, 3, and 11 (EFKA, AADE, NBG) — these contain the strongest identification evidence

**Estimated MLAT timeline:** 3-6 months for standard requests. Emergency provisions available under Article 17 for urgent matters.
...
*Cross-references: Tab 1 (Executive Summary) | Tab 6 (MLAT Map) | Tab 7 (Ask List) | MLAT Request Letter*

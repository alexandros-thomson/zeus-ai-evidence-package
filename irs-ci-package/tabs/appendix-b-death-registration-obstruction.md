# APPENDIX B: DEATH REGISTRATION OBSTRUCTION — TIMELINE AND ACTORS

**Classification:** IRS-CI Binder Appendix
**Subject:** Systematic obstruction of death registration for Ioannis "John" Kyprianos (AFM 051422558)
**Death Date:** June 13, 2021 — Roseville, Michigan, USA
**AADE Deactivation Date:** April 3, 2024 — 1,025 days post-mortem
**Date Created:** 01/04/2026 (Day 1,753)

---

## The 1,025-Day Gap

Ioannis Kyprianos died on June 13, 2021 in Roseville, Michigan. His Michigan death certificate was issued and available. Despite this, his Greek AFM (051422558) remained **active** in AADE systems until April 3, 2024 — a gap of **1,025 days** (2 years, 9 months, 21 days).

During this 1,025-day window, the following fraudulent acts occurred on the deceased's active AFM:

| Event | Date | Actor | Exhibit |
|---|---|---|---|
| False E1/E2 income tax filing (FY 2021) | 2022 | Accountant Aggeliki Papageorgiou | E-05, E-06 |
| False E1/E2 income tax filing (FY 2022) | 2023 | Accountant Aggeliki Papageorgiou | E-05, E-06 |
| False E1/E2 income tax filing (FY 2023) | 2024 | Accountant Aggeliki Papageorgiou | E-05, E-06 |
| ENFIA property tax issued to deceased | 2021-2024 | AADE automated system | E-13 |
| Efthalia Kyprianou operating as unauthorized tax representative | 2021-2026 | Efthalia Kyprianou (AFM 052822816) | E-14, E-21 |
| Contract 6020/2020 phantom property sale executed | 2020 | Notary Georgios Lyrakis | E-04, E-05 |

**Every one of these events required the AFM to be active.** The 1,025-day gap is not negligence — it is the structural prerequisite for the entire fraud chain.

---

## The Notary's Role: Georgios K. Lyrakis

Notary Georgios K. Lyrakis of Spetses is the **single point of failure** in the death registration chain.

### Documented Acts

1. **Contract 6020/2020**: Executed a phantom property sale during the period when he knew or should have known of John's death
2. **Death registration non-compliance**: Failed to register or facilitate the death registration for 1,025 days (June 2021 - April 2024)
3. **Protocol 166 vs 136 mismatch**: The notarial protocol numbers do not align with the claimed sequence of events
4. **SLAPP threat (26/02/2026)**: Upon being confronted about these irregularities, Lyrakis issued a legal threat against the complainant rather than addressing the substance

### Legal Exposure

| Jurisdiction | Statute | Offense |
|---|---|---|
| Greece | Art. 216 ΠΚ | Forgery (πλαστογραφία) |
| Greece | Art. 386 ΠΚ | Fraud (απάτη) |
| Greece | Art. 259 ΠΚ | Breach of duty (παράβαση καθήκοντος) |
...
The Municipality of Spetses bears responsibility for the death registration failure:

- **Mayor of Spetses**: Failed to ensure timely processing of death registration; subject of Art. 259 ΠΚ criminal complaint (E-21)
- **Municipal Registry (Ληξιαρχείο)**: Did not process the death registration within the legally mandated timeframe
- **Αποκεντρωμένη Διοίκηση Αττικής**: Issued ΕΠΕΙΓΟΝ order (Πρωτ. 18058, 16/03/2026) to the municipality, then reversed to threatening the complainant as "abusive" 4 days later (Πρωτ. 19466, 20/03/2026) — Contradiction C-3

---

## The Downstream Impact: How the Gap Enabled U.S. Tax Fraud

The 1,025-day active AFM window created the conditions for the $24,016 in false Foreign Tax Credits on the U.S. returns:

```
John dies (13/06/2021)
    |
    v
AFM 051422558 stays ACTIVE (1,025 days)
    |
    v
Papageorgiou files false E1/E2 returns (2021-2024)
    |
    v
False Greek tax obligations appear in AADE system
    |
    v
H&R Block imports false Greek tax data into Form 1116
    |
    v
$24,016 in fraudulent Foreign Tax Credits claimed
    |
    v
IRS CI Case 26236541 / AAA Case 01-26-0001-2493
```

**Without the 1,025-day gap, none of this happens.** Lyrakis's failure to register the death is not a separate issue — it is the enabling act for the entire fraud scheme.

---

## Connection to Phantom Business (Appendix Cross-Reference)

The phantom business registered on AFM 044594747 (Stamatina, 26/05/1992) intersects with the death registration obstruction:

- The 1992 phantom business predates the death by 29 years — identity compromise began decades before exploitation
- AADE's automated Α.1058/2026 POS compliance push to AFM 051422558 (31/03/2026) proves the systems remain interlinked even after death deactivation
- The cross-AFM routing (business on 044594747, compliance to 051422558) demonstrates systemic identity confusion that the 1,025-day gap exploited

See: `modules/PHANTOM-BUSINESS-1992-module.md` and `tabs/ASK-PB1-binder-tab7.md`

---

## Agencies Notified About Death Registration Obstruction

| Agency | Protocol | Date | Response |
|---|---|---|---|
| Εισαγγελία Πειραιά | ΑΒΜ 14678 | Feb 2026 | Criminal jurisdiction accepted |
| ΥΠΕΣ | ΑΠ 14693 | 16/03/2026 | "No legal defect found" (contradicts Αποκεντρωμένη) |
| Αποκεντρωμένη Αττικής | Πρωτ. 18058 | 16/03/2026 | ΕΠΕΙΓΟΝ order, then reversed to threat |
| Δήμος Σπετσών | Via Αποκεντρωμένη | 16/03/2026 | Non-compliant |
...
A Greek notary failed to register a U.S. citizen's death for 1,025 days, enabling false tax filings on the deceased's active AFM that generated $24,016 in fraudulent Foreign Tax Credits on the surviving spouse's U.S. returns — and when confronted, every Greek agency either contradicted itself, went silent, or threatened the complainant.
